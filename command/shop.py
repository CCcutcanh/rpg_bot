...
class Shop(commands.Cog):
    ...
    async def shop(self, ctx):
        try:
            ...
            send = await ctx.send(f"**Đây là các vật phẩm hiện có trong Shop:**\n\n*==Vật phẩm hồi HP==*\n<:binhHP:1118551444497375292>(id: 01): Hồi 40HP cho nhân vật để có thể tiếp tục đi săn (25<:vang:1116221866273681510>)\n\n*==Vật phẩm tăng số quái có thể săn==*\n <:kiemC1:1118523931406631023>(id: 02): Mỗi lần đi săn có tỉ lệ 40% săn được hai quái cùng lúc (80<:vang:1116221866273681510>)\n<:kiemC2:1118524150756163686>(id: 03): Mỗi lần đi săn có tỉ lệ 60% săn được hai quái cùng lúc(110<:vang:1116221866273681510>)\n<:kiemC3:1118524395766415370>(id:04): Mỗi lần đi săn sẽ săn được hai quái thú(150<:vang:1116221866273681510>)\n\nReply tin nhắn này với id vật phẩm bạn muốn mua để mua vật phẩm\n*Vật phầm bạn mua sẽ thay thế vật phẩm hiện tại bạn đang sử dụng ngoại trừ vật phẩm hồi HP*\nTổng số vàng hiện có: {coin}<:vang:1116221866273681510>")
            def check(m):
